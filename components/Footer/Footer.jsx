            ...
            <div className='footer-content'>
                <div className='footer-sitemap'>
                    ...
                    <div className='footer-links'>
                        <div className='link'>
                            <p>Contato</p>
                            <a href="https://wa.me/5522992877496">(22) 99287-7496</a>
                        </div>
                        <div className='link'>
                            <p>E-mail</p>
                            <a href="https://mail.google.com/mail/u/0/#inbox?compose=GTvVlcSGLrbHPwGkcHwVMnwCtFHGFHRJdVgJxNDVWxWNvZXKXWkdxxtRHPPnpVcwFRtQCBgrlvqbb">wearecodelab@gmail.com</a>
                        </div>
                        <div className='link'>
                            <p>Orçamento</p>
                ...
                <div className='footer-social'>
                    ...
                    <div className='social-media-footer'>
                        ...
                        <a href='https://www.instagram.com/codelabtec/'>
